...
import suzukabot.modules.sql.global_bans_sql as gban_sql
import suzukabot.modules.sql.users_sql as user_sql
from suzukabot import dispatcher, OWNER_ID, DEV_USERS
