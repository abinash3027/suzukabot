...
from suzukabot import dispatcher, AI_API_KEY, OWNER_ID, SUPPORT_CHAT
import suzukabot.modules.sql.chatbot_sql as sql
from suzukabot.modules.log_channel import gloggable
from suzukabot.modules.helper_funcs.filters import CustomFilters
from suzukabot.modules.helper_funcs.chat_status import user_admin
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows suzukabot to talk and provides a more interactive group chat experience.
