...
from suzukabot import dispatcher, WHITELIST_USERS, TIGER_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID, SUPPORT_CHAT
from suzukabot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from suzukabot.modules.helper_funcs.extraction import extract_user
from suzukabot.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'suzukabot/elevated_users.json')
...
disasters = """ Suzuka Bot has bot access levels we call as *"Disaster Levels"*
...
Owner has complete bot access, including bot adminship in chats Suzuka Bot is at.
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in Suzuka Bot.
\n*Demons* - Have access go globally ban users across Suzuka Bot.
...
\n*Disclaimer*: The disaster levels in Suzuka Bot are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [Heroes Association](https://t.me/suzukabotsupport).
"""
