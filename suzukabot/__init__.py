...
if ENV:
    ...
    from suzukabot.config import Development as Config
...
from suzukabot.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
